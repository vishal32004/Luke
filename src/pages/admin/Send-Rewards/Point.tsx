    ...
    <div className="max-w-3xl mx-auto p-4 space-y-4">
        ...
        <CardContent className="pt-0">
          <div className="flex items-center justify-between">
            <p className="text-muted-foreground">
              Verify your business details to activate your account for sending
              rewards. Our team usually takes one business hour to verify after
              you submit.
            </p>
      ...
      <Card>
        ...
        <CardContent className="pt-0">
          <div className="flex items-center justify-between">
            <p className="text-muted-foreground">
              Reward points allow your recipients to earn points over time and
              redeem them for existing rewards from our marketplace.
            </p>
